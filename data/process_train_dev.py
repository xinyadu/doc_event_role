...
def read_files(doc_file, keys_file, args):
...
if __name__=='__main__':
    ...
    for div in ["train", "dev"]:
        ...
        doc_keys = read_files(doc_file, keys_file, args)  

        if args.full:
            doc_keys_file = open("processed/" + div + "_full.json", "w+")
        else:
